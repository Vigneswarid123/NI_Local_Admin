...
export class ContactComponent implements OnInit {
  ...
  addContact() {
    const contactobj = {
      contact_name: this.ContactpopupForm.value.cname,
      contact_phone: this.ContactpopupForm.value.cphone,
      contact_email: this.ContactpopupForm.value.cmail,
      
      contact_title : this.ContactpopupForm.value.ctitle,
      contact_notes : this.ContactpopupForm.value.cnotes,
      contact_type : this.ContactpopupForm.value.ctype,
      contact_status : 'Y',
      'contactgroupbrandtype' : 'G',
      'action' : 'A'
    };
